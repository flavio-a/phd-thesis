...
$\kstar$ can also be seen as a least fixpoint. \textit{(Star unfold)} axioms state it behaves as a fixpoint of the interesting operations, while \textit{(Star induction)} require it to be minimal.
