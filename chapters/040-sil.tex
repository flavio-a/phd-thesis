...
Atomic commands are handled by \silrule{atom}, which exploits the backward semantics and summarizes cases for \code{skip}, assignments and Boolean guards. In Sections~\ref{sec:sil:assign} we discuss further the rule for assignment when pre and postconditions are formulae instead of sets of states.
