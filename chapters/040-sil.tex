...
Using the backward semantics, we can characterize NC triples $\necctriple{P}{\regr}{Q}$ with the validity condition $\bwsem{\regr} Q \subseteq P$ (see Proposition~\ref{}\todo{mettere da qualche parte la proposizione, con la citazione a Zhang e Kaminski}), and this leads to the taxonomy in Figure~\ref{fig:sil:taxonomy}: we classify logics depending on (1) whether the condition is expressed in terms of forward or backward semantics and (2) whether it is an over or an under-approximation.
...
\paragraph{Rest}
\todo{Understand how much of this I wanna keep}
