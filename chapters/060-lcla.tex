...
Lastly, we exploit the IL/SIL analogy observed in the previous chapter to study further the possibility of using $\LCLA$ for backward analysis (which was first hinted in~\cite[\S 5.3]{BGGR23}, although without SIL).
