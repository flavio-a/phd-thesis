...
\newcommand{\vecscale}{0.85}
\newcommand{\cvec}[4]{\!{\scalebox{\vecscale}{$\!\begin{bmatrix} #1 \\ #2 \\ #3 \\#4 \end{bmatrix}\!$}}\!}
\newcommand{\hvec}[4]{\!{\scalebox{\vecscale}{$\!\begin{bmatrix} #1 & #2 & #3 & #4 \end{bmatrix}\!$}}\!}
