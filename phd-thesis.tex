...
%%%%%%%%%%%%%%%%%%%%%%% bibliography
\usepackage[style=alphabetic,sorting=ynt,maxbibnames=20,maxalphanames=4]{biblatex}
...
\input{chapters/040-ai-under}
\input{chapters/050-sil}
\input{chapters/060-lcla}
\input{chapters/070-pdr}
