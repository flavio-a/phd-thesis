...
%Abstract interpretation is a general framework for static analyses, that has been successfully applied to many fields. Given its flexibility, we are interested in using it to
